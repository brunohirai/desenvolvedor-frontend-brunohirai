...
$(function(){
    ...
    $.backgroundVideo($('#bg-video'), {
        ...
        "width": 846,
        "height": 476,
         // Change display image for video from here you want to use
        "path": "media/",        
...
function loadGoogleMap() {    
    ...
    var latlng = new google.maps.LatLng(-5.850947, -35.208721); // New York
    var settings = {
        zoom: 14,
        center: new google.maps.LatLng(-5.850947, -35.208721),
    ...
    var companyPos = new google.maps.LatLng(-5.850947, -35.208721);
